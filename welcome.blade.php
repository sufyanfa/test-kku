...
<section class="relative container px-4 max-w-5xl mx-auto py-16">
  <h2 class="text-xl text-gray-800 font-bold my-4">المنتجات المضافة</h2>
  <div id="products" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-6">
    <div class="group flex flex-col h-full border border-gray-200 shadow-sm rounded-xl">
      <div class="aspect-w-16 aspect-h-8">
        <img class="w-full object-cover rounded-t-xl h-60" src="https://w7.pngwing.com/pngs/472/714/png-transparent-laptop-notebook-application-software-note-taking-ipython-notebook-miscellaneous-angle-product.png" alt="Image Description">
      </div>
      <div class="p-4 md:p-6">
        ...
        <p class="text-sm text-gray-500">
          قلم بجودة عالية وفخامة.
        </p>
      </div>
      <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
        <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-bl-xl font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm sm:p-4" href="#">
          إضافة للسلة
          <span class="ml-auto text-primary">23ر.س</span>
...
<section class="relative container px-4 max-w-5xl mx-auto py-16">
  <h2 class="text-xl text-gray-800 font-bold my-4">المتاجر المضافة</h2>
    ...
    <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition" href="#">
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center">
          ...
          <div class="pl-3">
            <svg class="w-3.5 h-3.5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  <a href="#products" class="inline-flex justify-center rounded-lg text-sm hover:text-thir font-bold py-3 px-4 bg-white/0 text-slate-900 ring-1 ring-slate-900/10 hover:bg-white/25 hover:ring-slate-900/15 ">
